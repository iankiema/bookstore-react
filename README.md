...
<div align="center">
  ...
  <h3><b>Bookstore React README Template</b></h3>
...
# 📖 Bookstore React Website <a name="about-project"></a>



**Bookstore React**Bookstore React website is an application used to add,display and delete books.
...
```sh
  cd my-folder
  git clone https://github.com/iankiema/bookstore-react.git
```
